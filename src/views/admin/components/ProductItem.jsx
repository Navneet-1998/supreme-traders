...
const ProductItem = ({ product }) => {
  ...
  return (
    ...
    >
    <div
    className={`item item-products ${!product.id ? 'item-loading' : ''}`} // Corrected the conditional class binding
    ref={productRef}
  >
  <div className="grid grid-count-7" style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center" }}>
  <div className="grid-col item-img-wrapper" style={{ display: "flex", width: "8%", justifyContent: "flex-start", alignItems: "center" }}>
    {product.image ? (
  ...
  <div className="grid-col" style={{ display: "flex", width: "10%", justifyContent: "flex-start", alignItems: "center" }}>
  ...
  <div className="grid-col" style={{ display: "flex", width: "10%", justifyContent: "flex-start", alignItems: "center" }}>
    <a href={product.link || '#'} target="_blank" rel="noopener noreferrer">
      {product.link ? 'View Product' : <Skeleton width={50} />}
    </a>
  </div>
