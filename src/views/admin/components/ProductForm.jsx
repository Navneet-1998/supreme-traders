          ...
          <Form className="product-form">
            <div className="product-form-inputs">
              <div className="d-flex">
                ...
                &nbsp;
                <div className="product-form-field" style={{marginTop:"1.5%"}}>
                ...
                <div className="product-form-field" style={{marginLeft:"2px"}}>
                <Field
                  disabled={isLoading}
                  name="link"
                  type="text"
                  ...
                  {imageFile.imageCollection.length >= 1 && (
                    imageFile.imageCollection.map((image) => (
                      ...
                      className="product-form-delete-image"
                          ...
                          type="button"
                        >
                        <span style={{color:"white",  position: "absolute", top: "0px" ,right: "3px"}}>x</span> 
                        </div>
                        <ImageLoader
                          alt=""
                          src={image.url}
